...
export default function App() {
  ...
  return (
    <div className="relative w-full bg-[#000000] text-white overflow-x-hidden selection:bg-white selection:text-black">
      ...
      <section className="relative min-h-[100dvh] w-full flex flex-col justify-between overflow-hidden">
        ...
        <div
          ...
          className="relative w-full h-[380px] xs:h-[420px] sm:h-[480px] md:h-full md:min-h-0 md:max-h-none md:absolute md:inset-0 z-0 overflow-hidden shrink-0 pointer-events-none"
          aria-hidden="true"
        >
        ...
        <header
          id="main-site-header"
          className="relative z-30 w-full pl-6 sm:pl-8 md:pl-10 lg:pl-12 pr-6 sm:pr-8 md:pr-10 lg:pr-12 pt-6 sm:pt-8 md:pt-10 flex items-center justify-between"
        >
          {/* 1. Left: Brand Logo */}
        ...
        {/* Main Hero Container */}
        <main className="relative z-10 w-full pl-6 sm:pl-8 md:pl-10 lg:pl-12 pr-6 sm:pr-8 md:pr-10 lg:pr-12 pt-4 sm:pt-6 md:pt-10 lg:pt-12 pb-12 sm:pb-16 md:pb-20 lg:pb-24 flex-1 flex flex-col justify-end lg:justify-center">
          <div className="relative w-full max-w-7xl">
            
            {/* Left Column: Hero Typography & CTA */}
            <div className="pt-2 sm:pt-4 md:pt-6 max-w-3xl z-10">
            ...
            {/* Mobile & Tablet in-flow wrapper for cards (< lg) */}
            <div className="lg:hidden flex flex-col sm:flex-row items-center justify-start gap-4 mt-8 z-20">
              {/* Mobile Card 1 */}
              <div className="w-full sm:w-1/2 p-5 rounded-[24px] bg-white/20 backdrop-blur-xl border border-white/30 shadow-xl text-white select-none">
                <h3 className="text-sm sm:text-base font-medium leading-snug tracking-tight text-white">
                ...
                <div className="mt-4 pt-2.5 border-t border-white/20 flex items-center justify-between">
                  <a href="#assessment" className="text-xs text-white/95 underline underline-offset-4 decoration-white/40">
                    Personal Assessment
                  </a>
                  <span className="w-7 h-7 rounded-full bg-white text-black flex items-center justify-center text-xs font-bold shadow">
                    ↗
                  </span>
                </div>
              </div>
              ...
              <div className="w-full sm:w-1/2 p-5 rounded-[24px] bg-white/20 backdrop-blur-xl border border-white/30 shadow-xl text-white select-none">
                <div className="flex items-center -space-x-2 mb-2.5">
                  <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=120&h=120&q=80" alt="1" className="w-8 h-8 rounded-full object-cover ring-2 ring-white/90" />
                  <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=120&h=120&q=80" alt="2" className="w-8 h-8 rounded-full object-cover ring-2 ring-white/90" />
                  <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=120&h=120&q=80" alt="3" className="w-8 h-8 rounded-full object-cover ring-2 ring-white/90" />
                </div>
                <div className="text-2xl font-semibold tracking-tight text-white leading-none">14K+</div>
                <p className="mt-1.5 text-xs text-white/95 font-normal leading-snug">People have already optimized their wellness</p>
              </div>
            </div>
        ...
        {/* 2. Desktop Floating Cards (Positioned precisely in the red boxes) */}
        {/* Card 1: Left red box (Over the pink flower at the bottom-left of jar) */}
        <div
          id="glass-card-assessment"
          className="hidden lg:block lg:absolute lg:left-[47%] xl:left-[48%] 2xl:left-[49%] lg:bottom-[12%] xl:bottom-[14%] 2xl:bottom-[16%] w-[275px] xl:w-[295px] p-5 xl:p-6 rounded-[28px] bg-white/20 backdrop-blur-xl border border-white/30 shadow-[0_16px_36px_rgba(0,0,0,0.35)] text-white transition-all duration-300 hover:bg-white/25 hover:scale-[1.02] select-none z-20"
        >
          <h3 className="text-base xl:text-[1.1rem] font-medium leading-snug tracking-tight text-white">
          ...
          <div className="mt-5 pt-3 border-t border-white/20 flex items-center justify-between">
            <a
              ...
              className="text-xs xl:text-[13px] font-normal text-white/95 hover:text-white underline underline-offset-4 decoration-white/40 hover:decoration-white transition-all"
            >
              Personal Assessment
            </a>
            <a
              ...
              className="w-8 h-8 rounded-full bg-white text-black flex items-center justify-center shadow-md transition-transform duration-200 hover:scale-110 active:scale-95 shrink-0"
            >
        ...
        {/* Card 2: Right red box (To the right of the jar, centered around middle height) */}
        <div
          id="glass-card-community"
          className="hidden lg:block lg:absolute lg:right-[3%] xl:right-[4%] 2xl:right-[5%] lg:top-[44%] xl:top-[45%] w-[265px] xl:w-[285px] p-5 xl:p-6 rounded-[28px] bg-white/20 backdrop-blur-xl border border-white/30 shadow-[0_16px_36px_rgba(0,0,0,0.35)] text-white transition-all duration-300 hover:bg-white/25 hover:scale-[1.02] select-none z-20"
        >
          ...
          <div className="flex items-center -space-x-2.5 mb-3.5">
            <img
              ...
              className="w-9 h-9 sm:w-10 sm:h-10 rounded-full object-cover ring-2 ring-white/90 shadow-md"
              referrerPolicy="no-referrer"
            />
            <img
          ...
          {/* Description Subtext */}
          <p className="mt-2 text-xs sm:text-[13px] text-white/95 font-normal leading-snug">
            People have already optimized their wellness
          </p>
        </div>
      </section>

      {/* 2. Warm Beige Banner Section (Below the 100vh Hero Fold) */}
      <section
        id="imbalance-solution-banner"
        className="relative z-20 w-full bg-[#E5E2DC] text-[#111111] py-20 sm:py-24 md:py-28 lg:py-32 px-6 sm:px-10 md:px-14 lg:px-16 xl:px-20 border-t border-[#D5D1C9]"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="md:col-span-7 lg:col-span-8">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-[3.35rem] font-medium sm:font-semibold text-[#111111] tracking-[-0.03em] leading-[1.1] select-none">
      ...
      {/* 3. Subtle Footer Bar */}
      <footer className="relative z-20 w-full bg-[#E5E2DC] border-t border-[#D5D1C9]/70 py-8 px-6 sm:px-10 md:px-14 lg:px-16 xl:px-20 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-neutral-600">
